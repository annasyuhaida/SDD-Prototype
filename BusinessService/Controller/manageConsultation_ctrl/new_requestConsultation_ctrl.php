...
class new_requestConsultation_ctrl {
    ...
    public function getUsersAction() {
        ...
        require_once '../App/View/ManageRegistration/new_requestConsultation.php';
        $view = new new_requestConsultation();
        $view->render($users);
    }
    public function new_requestConsultationAction($consultation_ID, $consultation_Purpose ,$marriageNo ,$consultation_Date ,$consultation_Time , $consultation_Desc)
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $model->new_requestConsultation($consultation_ID, $consultation_Purpose ,$marriageNo ,$consultation_Date ,$consultation_Time , $consultation_Desc);
