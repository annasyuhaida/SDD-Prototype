                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h4>Verify Pre Marriage Course</h4>
                                </div>
                                <div class="row">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>BTG1P/2022-00408</td>
                                                <td><?php echo $participant['applicantName']; ?></td>
                                                <td><?php echo $participant['applicantIC']; ?></td>
                                                <td><?php echo $participant['pre_m_series']; ?></td>
                                                <td><span>
                                                        <a href="index.php?action=updateOnlineVerify&Lid=0&courseID=<?php echo $participant['pre_m_reg_ID']; ?>" title="Approve"><i class="fa fa-check-square-o color-muted m-r-5"></i></a>
                                                        <a href="index.php?action=updateOnlineVerify&Lid=1&courseID=<?php echo $participant['pre_m_reg_ID']; ?>" title="Reject"><i class="fa fa-window-close-o color-muted m-r-5"></i></a>
                                                    </span>
                                                </td>
                                            </tr>
                                            <?php } ?>
