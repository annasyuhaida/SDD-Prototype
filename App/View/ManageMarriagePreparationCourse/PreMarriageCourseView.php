                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="">Register Marriage Preparation Course</a></li>
                        </ul>
        ...
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                            <div class="button-right-box col-md-2"><a href="index.php?action=PreMarriageList&Lid=0&appID=<?php echo $app['applicantID']; ?>&courseID=0" class="btn btn-primary btn-block">Register New</a></div>
