...
class MarriageCourseDetailsForm {
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="index.php?action=createMarriageCourse" method="POST">
                                        <div class="row form-material">
                                                <div class="col-md-12">
                                                    <label class="m-t-20">Organizer:</label>
                                                    <input type="text"  name="organiser" class="form-control input-rounded" placeholder="e.g. Alex">
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="m-t-20">Venue:</label>
                                                    <input type="text" name="venue1" class="form-control input-rounded" placeholder="e.g. No.11 Taman Chempaka">
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <input name="date" class="form-control input-limit-datepicker input-rounded" type="text" name="daterange" >
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <label class="m-t-20">Capacity:</label>
                                                    <input type="text" name="capacity" class="form-control input-rounded" placeholder="e.g. 100">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="m-t-20">Officer:</label>
                                                    <input type="text" name="officer" class="form-control input-rounded" placeholder="e.g. Ustaz Mohd Sobri">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="m-t-20">Briefing Series:</label>
                                                    <input type="text" name="series" class="form-control input-rounded" placeholder="e.g. BTG/0001/2023">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="m-t-20">Phone Number:</label>
                                                    <input type="text" name="phoneno" class="form-control input-rounded" placeholder="e.g. +60123456789 ">
                                                </div>
